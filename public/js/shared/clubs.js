...
export const CLUBS = [
  ...
  { key: 'DR', label: 'Driver',   type: 'wood',   speed: 73.8, launch: 11.5, spin: 2500,  curve: 1.35, minPow: 0.55, loft: 10.5 },
  { key: 'W3', label: '3 Wood',   type: 'wood',   speed: 66.6, launch: 13.5, spin: 3300,  curve: 1.20, minPow: 0.50, loft: 15 },
  { key: 'W5', label: '5 Wood',   type: 'wood',   speed: 62.5, launch: 15.0, spin: 3900,  curve: 1.12, minPow: 0.50, loft: 18 },
  { key: 'I2', label: '2 Iron',   type: 'iron',   speed: 60.7, launch: 15.0, spin: 3900,  curve: 1.14, minPow: 0.45, loft: 18 },
  { key: 'W7', label: '7 Wood',   type: 'wood',   speed: 59.8, launch: 16.5, spin: 4400,  curve: 1.06, minPow: 0.48, loft: 21 },
  { key: 'I3', label: '3 Iron',   type: 'iron',   speed: 58.9, launch: 16.5, spin: 4300,  curve: 1.08, minPow: 0.42, loft: 21 },
  { key: 'H3', label: '3 Hybrid', type: 'hybrid', speed: 58.8, launch: 16.0, spin: 4300,  curve: 1.02, minPow: 0.44, loft: 19 },
  { key: 'I4', label: '4 Iron',   type: 'iron',   speed: 57.4, launch: 17.5, spin: 4700,  curve: 1.02, minPow: 0.40, loft: 24 },
  { key: 'H4', label: '4 Hybrid', type: 'hybrid', speed: 56.3, launch: 17.5, spin: 4700,  curve: 0.99, minPow: 0.42, loft: 22 },
  { key: 'I5', label: '5 Iron',   type: 'iron',   speed: 54.7, launch: 19.0, spin: 5300,  curve: 0.96, minPow: 0.40, loft: 27 },
  { key: 'H5', label: '5 Hybrid', type: 'hybrid', speed: 53.9, launch: 19.0, spin: 5200,  curve: 0.96, minPow: 0.40, loft: 25 },
  { key: 'I6', label: '6 Iron',   type: 'iron',   speed: 52.3, launch: 21.0, spin: 6100,  curve: 0.90, minPow: 0.35, loft: 30 },
  { key: 'I7', label: '7 Iron',   type: 'iron',   speed: 49.7, launch: 23.0, spin: 6900,  curve: 0.84, minPow: 0.30, loft: 34 },
  { key: 'I8', label: '8 Iron',   type: 'iron',   speed: 47.3, launch: 25.5, spin: 7800,  curve: 0.78, minPow: 0.25, loft: 38 },
  { key: 'I9', label: '9 Iron',   type: 'iron',   speed: 44.9, launch: 28.0, spin: 8700,  curve: 0.72, minPow: 0.20, loft: 42 },
  { key: 'PW', label: 'Pitching', type: 'wedge',  speed: 42.5, launch: 30.5, spin: 9400,  curve: 0.66, minPow: 0.15, loft: 46 },
  { key: 'GW', label: 'Gap',      type: 'wedge',  speed: 39.4, launch: 33.0, spin: 10000, curve: 0.60, minPow: 0.10, loft: 50 },
  { key: 'SW', label: 'Sand',     type: 'wedge',  speed: 35.3, launch: 36.5, spin: 10600, curve: 0.55, minPow: 0.05, loft: 54 },
  { key: 'LW', label: 'Lob',      type: 'wedge',  speed: 30.8, launch: 43.0, spin: 11200, curve: 0.50, minPow: 0.05, loft: 58 },
